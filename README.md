...
The Random Forest classifier achieves ~97% accuracy on the test set. The confusion matrix and feature importance are saved in the outputs folder after running the training script.
